function r=ksr_rje(x,y,h,N)
% KSR   Kernel smoothing regression
%
% slightly edited by RJE to enable h to be left free while specifying N (2016.02.25)
% http://www.mathworks.com/matlabcentral/fileexchange/19195-kernel-smoothing-regression
%
%
