function [result] = corr_path_fmri(M)

% find the path which maximizes the observed r-values
% 
%     nc = corr_norm(M): a matrix M = [V x K] of K images, 
%     and nc is a K x K matrix of nc values
%
% note: program gets slow if there are > 50 columns (i.e., a 50-way conjunction). 
